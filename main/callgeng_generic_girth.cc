// This is a program calls geng as a procedure in order to generate graphs of a
// given minimum girth. At compile time, assign a name to the macros OUTPROC and
// GENG_MAIN. A typical Unix-style compilation command would be:
